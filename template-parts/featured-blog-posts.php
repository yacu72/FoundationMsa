...
<div class="posts-panel grid">
  ...
  <div class="panel-content">
    ...
    <section class="pinned-post">
      ...
      <div class="post-item">
        ...
        <a href="#" class="post-thumbnail">
          <img src="https://unsplash.it/306/?random" alt="">
        </a>
    ...
    <section class="posts-list">
      <div class="post-item">
        <a href="#" class="post-thumbnail">
          <img src="https://unsplash.it/301/?random" alt="">
        </a>
        <div class="post-text">
          <a href="#">
            <h3 class="post-title">Post title place-holder</h3>
      ...
      <div class="post-item">
        <a href="#" class="post-thumbnail">
          <img src="https://unsplash.it/302/?random" alt="">
        </a>
        <div class="post-text">
          <a href="#">
            <h3 class="post-title">Post title place-holder</h3>
      ...
      <div class="post-item">
        <a href="#" class="post-thumbnail">
          <img src="https://unsplash.it/303/?random" alt="">
        </a>
        <div class="post-text">
          <a href="#">
            <h3 class="post-title">Post title place-holder</h3>
      ...
      <div class="post-item">
        <a href="#" class="post-thumbnail">
          <img src="https://unsplash.it/304/?random" alt="">
        </a>
        <div class="post-text">
          <a href="#">
            <h3 class="post-title">Post title place-holder</h3>
